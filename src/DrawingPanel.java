...
implements ActionListener, MouseMotionListener, Runnable, WindowListener {
	...
	*/
	...
	ChangeListener {
		 ...
		 *  class constructor -
		 *
		 * @param file1 String name of the file
		 * @param file2 String name of the file
		 */
		 ...
		 *
		 * @param input1 File object
		 * @param input2 File object
		 */
		 ...
		 *
		 * @param input1 InputStream object
		 * @param input2 InputStream object
		 * @return IOException
		 */
		...
		/**
		 *  saves imgage to the provided file
		 *
		 * @param file name File object
		 */
		...
		/**
		 *  creates a new File object based on the name provided
		 *
